...
import static de.uni_leipzig.mack.utils.TestUtils.createResultRelevancePair as resRelPair
...
class MRRTest extends GroovyTestCase {
    ...
    @Lazy
    protected Collection<ResultRelevancePair> rrPairs = ImmutableList.of(
